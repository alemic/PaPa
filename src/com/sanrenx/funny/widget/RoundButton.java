...
public class RoundButton extends ImageView {
	...
	private static final int PRESSED_RING_ALPHA = 85;
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundButton);
			color = a.getColor(R.styleable.RoundButton_button_color, color);
			pressedRingWidth = (int) a.getDimension(R.styleable.RoundButton_button_pressed_ring_width, pressedRingWidth);
			a.recycle();
		}
