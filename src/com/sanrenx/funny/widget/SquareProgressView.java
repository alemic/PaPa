package com.sanrenx.funny.widget;
...
public class SquareProgressView extends View {
	...
	public SquareProgressView(Context context) {
		...
		progressBarPaint.setStrokeWidth(convertDpToPx(widthInDp, getContext()));
		progressBarPaint.setAntiAlias(true);
		progressBarPaint.setStyle(Style.STROKE);

		outlinePaint = new Paint();
		outlinePaint.setColor(context.getResources().getColor(android.R.color.holo_blue_bright));
	...
	public SquareProgressView(Context context, AttributeSet attrs) {
		super(context, attrs);
		progressBarPaint = new Paint();
		progressBarPaint.setColor(context.getResources().getColor(android.R.color.holo_blue_bright));
		progressBarPaint.setStrokeWidth(convertDpToPx(widthInDp, getContext()));
		progressBarPaint.setAntiAlias(true);
		progressBarPaint.setStyle(Style.STROKE);
	...
	private void drawPercent(PercentStyle setting) {
		...
		canvas.drawText(
				percentString,
				canvas.getWidth() / 2,
				(int) ((canvas.getHeight() / 2) - ((textPaint.descent() + textPaint.ascent()) / 2)), textPaint);
	}
